...
class Logger
{
   public:
     ...
     */
    void log(const string& message) const { cout << "[INFO]: " << message << endl; }

    /**
     * @brief Logs an integer value.
     * @param value The integer value to log.
     */
    void log(int value) const { cout << "[INFO]: Numeric value: " << value << endl; }
...
class Rectangle : public Shape
{
   ...
   public:
    ...
    void draw() const override
    {
        cout << "Drawing a " << color << " Rectangle with width " << width << " and height "
             << height << endl;
    }
...
class Triangle : public Shape
{
   ...
   public:
    ...
    void draw() const override
    {
        cout << "Drawing a " << color << " Triangle with base " << base << " and height "
             << triangleHeight << endl;
    }

    ~Triangle() override { cout << "Triangle destructor called." << endl; }
};
...
int main()
{
    ...
    // Demonstrate polymorphic call for the first shape in the vector
