...
int main()
{
    ...
    result = a / b;
    std::cout << "a / b (integer division) = " << result
              << std::endl;  // Expected: 3 (10 / 3 = 3.33...)

    // To get floating-point division, at least one operand must be a float/double.
    double floatA = 10.0;
    double floatB = 3.0;
    double floatResult = floatA / floatB;
    std::cout << "floatA / floatB (floating-point division) = " << floatResult
              << std::endl;  // Expected: 3.333...

    // Modulus operator (%)
    // Returns the remainder of an integer division.
    result = a % b;
    std::cout << "a % b (remainder) = " << result
              << std::endl;  // Expected: 1 (10 / 3 = 3 with remainder 1)
    ...
    // Equal to (==)
    booleanResult = (a == b);
    std::cout << "a == b: " << booleanResult
              << std::endl;  // Expected: false (10 is not equal to 3)
    ...
    booleanResult = (a < b);
    std::cout << "a < b: " << booleanResult
              << std::endl;  // Expected: false (10 is not less than 3)

    // Greater than or equal to (>=)
    booleanResult = (a >= b);
    std::cout << "a >= b: " << booleanResult
              << std::endl;  // Expected: true (10 is greater than or equal to 3)

    // Less than or equal to (<=)
    booleanResult = (a <= b);
    std::cout << "a <= b: " << booleanResult
              << std::endl;  // Expected: false (10 is not less than or equal to 3)
    ...
    result = count++;
    std::cout << "result = count++; result = " << result << ", count = " << count
              << std::endl;  // result=5, count=6

    // Pre-increment (++count)
    // Increments count, then uses the new value of count.
    result = ++count;
    std::cout << "result = ++count; result = " << result << ", count = " << count
              << std::endl;  // result=7, count=7

    // Post-decrement (count--)
    result = count--;
    std::cout << "result = count--; result = " << result << ", count = " << count
              << std::endl;  // result=7, count=6

    // Pre-decrement (--count)
    result = --count;
    std::cout << "result = --count; result = " << result << ", count = " << count
              << std::endl;  // result=5, count=5
    ...
    std::cout << "Max of " << num1 << " and " << num2 << " is: " << max
              << std::endl;  // Expected: 15
