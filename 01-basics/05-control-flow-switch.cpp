...
int main()
{
    ...
    switch (dayOfWeek)
    {
        ...
        case 7:  // If dayOfWeek is 7
            ...
            break;
        default:  // The 'default' case is optional and executes if no 'case' matches the
                  // expression.
    ...
    // Each 'case' label must be a constant integral expression (e.g., an integer or a character
    // literal).
    switch (grade)
    {
        case 'A':
